    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-4xl font-black leading-tight text-gray-900 sm:text-4xl xl:mb-8">DIAGNOSA PENYAKIT TANAMAN BAWANG MERAH</h1>
                ...
                <div x-data="{ isModalOpen: false }">
                    ...
                    <div
                        ...
                        class="fixed inset-0 z-[999] flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center">
                        <!-- Modal -->
                        <div
                            x-show="isModalOpen"
                            x-transition:enter="transition ease-out duration-150"
            ...
            <div class="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
                <div class="container relative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">
                    <img src="img/onion.png"
                        class="rounded-full w-full h-auto mt-20 mb-20 ml-0 lg:mt-24 xl:mt-20 lg:mb-0 lg:h-full lg:-ml-12 z-10">
                </div>
            </div>
        </div>
    </div>
