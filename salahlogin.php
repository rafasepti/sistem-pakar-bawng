...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><button type="button" class="btn btn-primary btn-block" id="myBtn2">REGISTER</button></p>  
    </div>
        ...
        <div class="modal-body" style="padding:40px 50px;">
          ...
          <form role="form" method="post" action="register.php">
            ...
            <label for="username"><span class="glyphicon glyphicon-user"></span> Nama</label>
              <input type="text" class="form-control" name="nama" id="nama" placeholder="Enter username">
            </div>
            <div class="form-group" method="post">
              <label for="username"><span class="glyphicon glyphicon-user"></span> Username</label>
            ...
            <div class="form-group" method="post">
              ...
              <button type="submit" id="submit" nama="submit" class="btn btn-primary btn-block" method="post"><span class="glyphicon glyphicon-off"></span> Register</button>
          </form>     
