        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    $sql = "SELECT idgejala FROM gejala ORDER BY idgejala DESC LIMIT 1";
                    $result = $konek_db->query($sql);

                    // Cek apakah ada data
                    if ($result->num_rows > 0) {
                        $row = $result->fetch_assoc();
                        $lastId = $row['idgejala']; // Contoh: "P001"
                        ...
                        $newId = "G" . str_pad($newNumber, 3, "0", STR_PAD_LEFT);
                    } else {
                        ...
                        <form id="formGejala" data-toggle="validator" action="aksi_gejala.php" method="POST" role="form">
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input
                                    ...
                                    id="gejala"
                                    required
                                    data-error="Nama gejala wajib diisi." />
                            ...
                            <div class="flex justify-end">
                                <button type="submit" name="tambah_gejala" class="px-4 py-2 mt-6 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                    Simpan
                                </button>
                            </div>
                        </form>
