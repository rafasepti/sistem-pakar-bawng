                    ...
                    ?>
                        <div
                            ...
                            <form id="formBasis" data-toggle="validator" action="aksi_basis.php" method="POST" role="form">
                                ...
                                function tampilkanGejala($daerah, $jenistanaman, $gejala_array, $konek_db)
                                {
                                    ...
                                    while ($hasil = mysqli_fetch_array($query)) {
                                        ...
                                        echo "<label class='flex items-center space-x-2'>
                                            <input type='checkbox' value='$idgejala' name='gejala[]' class='rounded border-gray-300 text-purple-600 focus:ring-purple-500' $checked />
                                            <h4>$gejala</h4>
                                        </label>";
                                ...
                                <button type="submit" name="edit_basis" class="px-4 py-2 mt-6 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                    Simpan
                                </button>
                            </div>
                            </form>
