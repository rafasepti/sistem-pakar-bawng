            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <div
                        ...
                        <a class="flex items-center space-x-2 px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="tambah_basis.php">
                            <!-- Ikon "+" -->
                    ...
                    $query = "
                        SELECT 
                            p.idpenyakit, 
                            p.namapenyakit,
                            GROUP_CONCAT(g.gejala SEPARATOR ', ') AS daftar_gejala
                        FROM 
                            basispengetahuan bp
                        INNER JOIN 
                                ...
                                <tbody
                                    ...
                                    ?>
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <?php echo $gejala_terbatas ?>
                                            </td>
                                            <td class="px-4 py-3">
                                                <div class="flex items-center space-x-4 text-sm">
                                                    <a href="detail_basis.php?id=<?php echo $data[0]; ?>"
                                                    ...
                                                    <a href="edit_basis.php?id=<?php echo $data[0]; ?>"
                                                        class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                        aria-label="Edit">
                                                        <svg
                                                            class="w-5 h-5"
                                                    ...
                                                    <a href="hapus_basis.php?id=<?php echo $data[0]; ?>"
                                                        class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                        aria-label="Delete"
