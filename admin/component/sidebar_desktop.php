        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                ...
                <a
                    ...
                    <span class="ml-4">Gejala</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                <?php if (strpos($currentUrl, 'basis.php') !== false): ?>
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                <?php endif; ?>
                <a
                    class="inline-flex items-center w-full text-sm font-semibold <?php echo (strpos($currentUrl, 'basis.php') !== false) ? 'text-gray-800' : ''; ?> transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="<?php echo BASE_URL; ?>admin/basis_pengetahuan/basis.php">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5"
                        aria-hidden="true"
                        fill="none"
                    ...
                    <span class="ml-4">Basis Pengetahuan</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                <?php if (strpos($currentUrl, 'diagnosa.php') !== false): ?>
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                <?php endif; ?>
                <a
                    class="inline-flex items-center w-full text-sm font-semibold <?php echo (strpos($currentUrl, 'diagnosa.php') !== false) ? 'text-gray-800' : ''; ?> transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="<?php echo BASE_URL; ?>admin/diagnosa/diagnosa.php">
                    <svg
                        class="w-5 h-5"
                        aria-hidden="true"
                        fill="none"
                    ...
                    <span class="ml-4">Diagnosa Penyakit</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                <?php if (strpos($currentUrl, 'about.php') !== false): ?>
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                <?php endif; ?>
                <a
                    class="inline-flex items-center w-full text-sm font-semibold <?php echo (strpos($currentUrl, 'about.php') !== false) ? 'text-gray-800' : ''; ?> transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="<?php echo BASE_URL; ?>admin/about.php">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-5 h-5"
                        aria-hidden="true"
                        fill="none"
